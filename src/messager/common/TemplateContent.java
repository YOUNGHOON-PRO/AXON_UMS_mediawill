...
public class TemplateContent implements java.io.Serializable {
	...
	public TemplateContent(Template template) {
          //기본은 한국어, 8bit 로 한다.
          this(template, null, "EUC-KR", "8bit");
	}

	public TemplateContent(Template template, String charsetCode, String encCode) {

		this(template, null, charsetCode, encCode);

	}

	public TemplateContent(Template template, String contentTypeCode,
	...
	public TemplateContent(Template2 template2, String contentTypeCode,
			String charsetCode, String encCode) {
...
*/
	 ...
	 */
	public TemplateContent(Template template, String fileName, MailHeaderEncoder headerEncoder)
